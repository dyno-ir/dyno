...
#define TYPES(x) \
  ...
  x("symbol",   CORE_SYMBOL,    4 | TY_DEF_USE_START)
// clang-format on
...
static constexpr CoreOpc CORE_EXPORT{1};
static constexpr CoreOpc CORE_IMPORT{2};
...
#undef TYINFO_EXPAND
  ...
  constexpr static OpcodeInfo opcInfo[] = {{"INVALID"}, {"EXPORT"}, {"IMPORT"}};
};
